...
<SCRIPT LANGUAGE="JavaScript" SRC="js/ModelIndAcceptRejectClause.js"></SCRIPT>

<div class="container" width="100%">
<html:form styleClass="form-horizontal" action="/ModelIndAcceptRejectClauseAction" method="post" >
	...
	<logic:present name="AcceptRejectClauseForm" property="clauseVersions">
		...
		<TABLE class="table table-bordered">
			<thead>	
				<TR>
					...
					<TH class="text-center" width="7%">Model Default</TH>
				</TR>
			</thead>
			<tbody>
				<logic:iterate id="clauseRev" name="AcceptRejectClauseForm"
					...
					<TR>
						...
						<TD class="text-center">
							<bean:write name="clauseRev" property="modelDefFlag" />
						</TD>
					</TR>
				</logic:iterate>
			</tbody>
		...
		<div class="form-group">
			<div class="col-sm-12 text-center">
				<button class="btn btn-primary" type='button' id="acceptBtn" ONCLICK="javascript:fnAcceptClauseChange()">Accept</button>
				<button class="btn btn-primary" type='button' id="rejectBtn" ONCLICK="javascript:fnRejectClauseChange()">Reject</button>
