		 ...
		 <div class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-sm-5 control-label">Model</label>
					<div class="col-sm-3 text-nowrap form-control-static">
			...
			<div class="form-group">
				<label class="col-sm-5 control-label">Title</label>
					<div class="col-sm-3 form-control-static">
						<bean:write name="ModelSpecificationForm" property="hdnSpecName" />
					</div>
			</div>
			<div class="form-group required-field">
				<label class="col-sm-5 control-label">Description</label>
					<div class="col-sm-3 ">
						<html:text property="modSpecItemDesc" styleClass="form-control" maxlength="2000" />
					</div>
			</div>
			<div class="form-group">
				<label class="col-sm-5 control-label">Value</label>
					<div class="col-sm-3">
						<html:text property="modSpecItemValue" styleClass="form-control" maxlength="100" />
					</div>
			</div>
		</div>
		<div class="spacer10"></div>
