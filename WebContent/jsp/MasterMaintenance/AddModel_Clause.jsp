...
<logic:empty name="clsize1">
	...
	<div class="form-group">
		...
		<div class="col-sm-4 form-inline">
			 <html:checkbox  name="ModelAddClauseForm" property="selectCGCFlag" styleId="sltCGCFlag" onclick="javascript:fnCharacteristicCompGroup()"  />
		</div>
	</div>
	<div class="form-group">
...
<logic:greaterThan name="clsize1" value="0">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label">Characteristic Group Clause</label>
		<div class="col-sm-4 form-inline">
			 <html:checkbox  name="ModelAddClauseForm" property="selectCGCFlag" id="sltCGCFlag" onclick="javascript:fnCharacteristicCompGroup()"  />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4 text-nowrap control-label">Select Lead ComponentGroup</label>
	...
	<div class="spacer30"></div>
		<div class="form-group">
			<div class="col-sm-offset-5 col-sm-3 text-center">
				...
				onclick="javascript:fnCheckSpellnCont('fnAddClause')">Add
				</button>
			</div>
		</div>
</div>
