...
* 19/01/2010    1.0      RR68151      Initialization of parameters edl/refedl     Added for CR_81
* 										Add Clause Rev Screen.  
* 													 	 
* 
* --------------------------------------------------------------------------------------------------------
**************************************************************************/
public class AddClauseRevForm extends EMDForm {
	...
	//Initiated parameters for CR_81 by RR68151 - Starts
	private String[] edlNo = {"","",""};
	
	private String[] RefEDLNo = {"","",""};
	//Initiated parameters for CR_81 by RR68151 - Ends 
